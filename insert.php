...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO song(song_id, song_name, song_img, song_singer, song_price, song_audio)
    VALUES ('$song_id', '$song_name', '$song_img', '$song_singer','$song_price','$song_audio')";
...
<!-- Form Name -->
<legend style="text-align: center;font-size: 50px;">Song</legend>
...
<div style="width: 500px;
    ...
    border-radius: 10px;">
        ...
        <div class="form-group">
          <div class="col-md-4">
            <button type="submit" name="singlebutton" class="btn btn-primary">Add</button>
          </div>
        </div>
</div>
